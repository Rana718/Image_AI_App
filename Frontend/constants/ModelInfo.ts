...
const AvatarModel: ModelInfo[] = [
    {
        name: 'Cyberpunk Avatar',
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731568945/tersx3ydowbtexkqide6.png',
        api: 'avatar',
    ...
    },
    {
        ...
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731569018/b9rt5vctkf1wg5rkchuy.png',
        api: 'avatar',
    ...
    },
    {
        ...
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731569062/lva43dglt3ydkje8nrgs.png',
        api: 'avatar',
    ...
    },
    {
        name: 'Anime Avatar',
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731569091/tgxaak2xaxawwmgoqv7g.png',
        api: 'avatar',
    ...
    },
    {
        name: 'Vampire Avatar',
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731569116/e0jdeaa1rp5mfkf1sw0k.png',
        api: 'avatar',
...
const StylingModel: ModelInfo[] = [
    {
        name: 'Steampunk',
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731569173/iafwyzh7aejjlsptzqte.png',
        api: 'avatar',
    ...
    },
    {
        name: 'Retro Vintage',
        upload: true,
        image: 'https://res.cloudinary.com/djqalecmu/image/upload/v1731569196/kxmvwsyywwihwnv9nh5c.png',
        api: 'avatar',
